...
# LC machines require "module load gcc/13.3.1" and -std=c2x.

# Power lab machines
ifneq ($(filter $(shell hostname), comus octomore rhetoric iris lupine gilia sorrel curry thompson),)
...
reproducer: Makefile reproducer.c
	$(CC) $(CFLAGS) $(LDFLAGS) reproducer.c -o rep
...
whereami:
	...
	@echo CC=$(CC)
	@echo `$(CC) --version`
	@echo hostname=$(shell hostname | sed -e "s/[0-9]//g")
